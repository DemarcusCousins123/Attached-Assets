          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
                Submit your car details or upload a deal sheet to CarConnects. Our expert advisors will analyze the market, score the deal, and give you professional recommendations. No upfront payment required—pay only after you get your car.
              </p>
            </motion.div>
          </div>
